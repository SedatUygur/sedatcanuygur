...
while I was writing my previous blog post. For the longest time I've wanted to add a header to code blocks so that
I could attach a filename to help with understanding where the code is meant to written to. I had tried to use some
different Rehype and Remark plugins in the past but they never quite worked as I wanted. This time around I told myself
I was going to figure out how to make it happen and I'm super happy with the results. Here is the finished result.
